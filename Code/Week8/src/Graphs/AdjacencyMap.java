...
import Graphs.AdjacencyList.InnerEdge;
import Graphs.AdjacencyList.InnerVertex;

public class AdjacencyMap<V, E> implements Graph<V, E> {

	class InnerVertex<V> implements Vertex<V> {
		private V elem;
		private Position<InnerVertex<V>> pos;
		private Map<Vertex<V>, InnerEdge<V, E>> outgoing;// +++++++ Itt a java-s map-et hasznalom, kesobb kicserelhetem a sajatomra.
		private Map<Vertex<V>, InnerEdge<V, E>> incoming;
